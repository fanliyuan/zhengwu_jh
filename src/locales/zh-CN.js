export default {
  ...
  'validation.dataSource.port.max': '数据库端口长度不能大于4个字符！',
  ...
  'validation.accessDataSource.syncAddDto.timeNum.type': '定时设置为数字！',
  'validation.accessDataSource.syncAddDto.timeNum.max': '定时设置长度不能大于3个字符！',
  'validation.accessDataSource.syncAddDto.stopNum.type': '自动停止为数字！',
  ...
  'form.dataSource.ftpIp.label': 'FTP地址',
  'form.dataSource.ftpPort.label': '端口',
  'form.dataSource.ftpUsername.label': 'FTP用户名',
  'form.dataSource.ftpPassword.label': 'FTP密码',
  ...
  'menu.informationResources': '政务信息资源目录',
  'menu.informationResources.audit': '信息资源审核',
  'menu.informationResources.subscriptionLicense': '订阅授权',
  'menu.informationResources.management': '信息资源管理',
  'menu.data': '数据发布管理',
