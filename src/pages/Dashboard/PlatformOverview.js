  ...
  series: [
    {
      ...
      data: [{ itemStyle: { color: '#000', size: '32' } }],
      tooltip: {
        formatter: 'zongshu',
      },
    },
...
export default class PlatformOverview extends Component {
  ...
  getDynamicLineData() {
    ...
    const dynamicData = [
      ...
      [
        ...source[1],
        lastData[1] + (Math.random() * 100).toFixed(0) * (Math.round(Math.random()) - 0.4),
      ],
      [
        ...source[2],
        lastData[2] + (Math.random() * 100).toFixed(0) * (Math.round(Math.random()) - 0.4),
      ],
      [
        ...source[3],
        lastData[3] + (Math.random() * 100).toFixed(0) * (Math.round(Math.random()) - 0.4),
      ],
    ];
    this.setState({
      lineData: {
  ...
  render() {
    ...
    const fakeData = [
      { title: '机构数量', content: 24 },
      { title: '节点数量', content: 24 },
      { title: '信息资源', content: 199 },
      { title: '接入资源', content: 102 },
      { title: '数据量', content: '24k·条' },
      { title: '文件量', content: '500.03·PB' },
      { title: '交换数', content: 102 },
      { title: '总交换数', content: 1024 },
    ];
            ...
            <Col span={9} className={styles.rightBox}>
              <div>
                <div className={styles.salesRank}>
                  <h3 className={styles.rankingTitle}>最活跃的节点</h3>
